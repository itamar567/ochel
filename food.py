...
_seaweed_effect = misc.Effect("Seaweed", 3, {"bonus": 10}, {})
...
_rotten_hardtack_ruby_effect = misc.Effect("Rotten Hardtack (Ruby)", 11, {"bonus": -10}, {})
_rotten_hardtack_fortress_effect = misc.Effect("Rotten Hardtack (Drowned Fortress)", 3, {"bonus": -10}, {})
